...
if verified_dataset:
    train_dictionary_path = f'./datasets/{qbits_num}qbits/train_bisep_no_pptes/negativity_bipartitions.txt'
    train_root_dir = f'./datasets/{qbits_num}qbits/train_bisep_no_pptes/matrices/'
else:
...
ghz_dictionary_path = f'./datasets/{qbits_num}qbits/ghz_mixed_test/negativity_bipartitions.txt'
ghz_root_dir = f'./datasets/{qbits_num}qbits/ghz_mixed_test/matrices/'
...
if verified_dataset:
    model_dir = f'./paper_models/{qbits_num}qbits/multi_class_siam_eq_log_10/no_pptes_bisep/'
    results_dir = f'./results/{qbits_num}qbits/multi_class_siam_eq_log_10/no_pptes_bisep/'
else:
    model_dir = f'./paper_models/{qbits_num}qbits/multi_class_siam_eq_log_10/negativity_bisep/'
    results_dir = f'./results/{qbits_num}qbits/multi_class_siam_eq_log_10/negativity_bisep/'
